...
- `cd SEI52-homework`
- `git remote add upstream https://github.com/carterdeacon/SEI52-homework.git`
...
2. Go to your local homework repo (eg, `cd ~/Projects/sei52-homework`);
3. From here, go to the folder matching your name within that repo, and the appropriate week / day (eg, `taylor_swift/week_01`);
