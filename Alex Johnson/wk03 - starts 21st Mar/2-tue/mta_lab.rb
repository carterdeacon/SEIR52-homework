...
def plan_trip (line, start_station , change_to, end_station, mta)
    puts " #{ line } ... #{ start_station } ... #{ change_to } ... #{ end_station }  "
    #  puts start_station
    start_station_index = mta[line.to_sym].index(start_station)
    end_station_index = mta[line.to_sym].index(end_station)
    # puts start_station_index
    # puts end_station_index
    
    total_stops = start_station_index + end_station_index
    puts total_stops
end 

plan_trip( "N", "Times Square", "N", "Union Square", mta_stations)