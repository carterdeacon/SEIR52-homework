...
const planTrip = function(){
    ...
    if (l1 in subwayMap && subwayMap[l1].includes(d1) && l2 in subwayMap && subwayMap[l2].includes(d2)){
    ...
    //if the prompt stations or line are not in the subway map, request a valid input and re-prompt.
    else{
